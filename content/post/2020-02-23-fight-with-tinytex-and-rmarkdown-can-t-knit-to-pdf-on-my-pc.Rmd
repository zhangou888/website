...
```{r fig1, out.width='20%', fig.align='center', fig.pos='h', fig.cap='R Markdown',echo = FALSE}
    ...
    knitr::include_graphics("/images/post/Tinytex/rmarkdown.jpg", error = FALSE)

```

After attending RStudio conference 2019 @Austin, I decided write my tech report for project in **R markdown**.

```{r fig2, out.width='20%', fig.align='center', fig.pos='h', fig.cap='RStudio Conf 2019',echo = FALSE}

    knitr::include_graphics("/images/post/Tinytex/rstudio_cof2019.jpg", error = FALSE)
...
```{r fig3, out.width='85%', fig.align='center', fig.pos='h', fig.cap='Cannot knit PDF error',echo = FALSE}
    ...
    knitr::include_graphics("/images/post/Tinytex/screen1.jpg", error = FALSE)
...
```{r fig4, out.width='20%', fig.align='center', fig.pos='h', fig.cap='TinyTex',echo = FALSE}
    ...
    knitr::include_graphics("/images/post/Tinytex/tinytex.jpg", error = FALSE)
...
```{r fig5, out.width='90%', fig.align='center', fig.pos='h', fig.cap='Yihui reply',echo = FALSE}

    knitr::include_graphics("/images/post/Tinytex/yihui.jpg", error = FALSE)
...
```{r fig6, out.width='85%', fig.align='center', fig.pos='h', fig.cap='What a creepy error',echo = FALSE}
    ...
    knitr::include_graphics("/images/post/Tinytex/screen2.jpg", error = FALSE)
...
```{r fig7, out.width='50%', fig.align='center', fig.pos='h', fig.cap=' ',echo = FALSE}
    ...
    knitr::include_graphics("/images/post/Tinytex/nothing.jpg", error = FALSE)
