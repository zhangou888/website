...
```{r fig3, out.width='50%', fig.align='center', fig.pos='h', fig.cap='Cannot knit PDF error',echo = FALSE}
...
```{r fig5, out.width='50%', fig.align='center', fig.pos='h', fig.cap='Yihui reply',echo = FALSE}
